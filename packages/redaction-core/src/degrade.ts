 ...
 * Account numbers are cue-backed in Tier-0 (cueDigitSpans); uncued free-text account values can still need
 * neural coverage, but the label itself is not neural-only. Organization and address remain neural-owned.
 */
