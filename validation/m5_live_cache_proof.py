#!/usr/bin/env python3
"""Context-ballooning closure -- LIVE end-to-end proof through the real egress proxy (run on M5).
...
def main():
    ...
    for name, passed in checks.items():
        ...
        ok = ok and passed
    srv.shutdown()
    print('\nRESULT:', 'ALL PASS -- cache stability + compaction enabler verified live on M5' if ok
          else 'FAILURE')
