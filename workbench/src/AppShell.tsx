...
const Redact = lazy(() =>
  // Exception: React.lazy uses this dynamic import to keep the heavy workbench out of the initial Firewall console chunk.
  import('./App')
)
const Console = lazy(() =>
  // Exception: React.lazy uses this dynamic import to avoid loading console code until its surface is selected.
...
export default function AppShell() {
  ...
  // Always prevent the browser/webview default "open this dropped file" navigation. Dropzone handles
  // actual intake while mounted; after a document is loaded this guard protects in-progress redactions.
  useEffect(() => {
